...
public:
	enum eOfflineEvent 
	{
		...
		Event_SyncGameResult, // { createUID : 2345 , roomID : 234 , roomType : 2 , clubID : 34, finishTime : 234554, duiringTime : 2345 , offset : -234 , finalCoin : 23456 , buyIn : 2345 , configID : 23 , roomName :  "roomName" } 
		Event_Max,
	};
