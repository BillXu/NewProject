...
typedef enum
{
    ...
    GotyeStatusCodeReloginOK                = 5,    ///< re-login success, liu@141217
    GotyeStatusCodeOfflineLoginOK           = 6,    ///< login success with offline mode liu@141217
    ...
    GotyeStatusCodeBlackList                = 805,  ///< you are in black list
    ...
    GotyeStatusCodeNotInGroup               = 810,  ///< user not in group
