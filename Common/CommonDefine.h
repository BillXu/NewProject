...
#define TIME_PLAYER_BET_COIN_ANI 1.2
#define TIME_BLIND_BET_STATE (TIME_PLAYER_BET_COIN_ANI + 1) 
#define TIME_TAXAS_BET 15
#define TIME_TAXAS_WAIT_COIN_GOTO_MAIN_POOL 1.7f
#define TIME_TAXAS_MAKE_VICE_POOLS 1.15f
#define TIME_TAXAS_DISTRIBUTE_ONE_HOLD_CARD (TIME_TAXAS_FILP_CARD + 0.6)
#define TIME_TAXAS_DISTRIBUTE_HOLD_CARD_DELAY ( 0.5 * TIME_TAXAS_DISTRIBUTE_ONE_HOLD_CARD )
#define TIME_DISTRIBUTE_ONE_PUBLIC_CARD 0.8
